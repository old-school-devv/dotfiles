...
defbindings("WMPlex.toplevel", {
    ...
    kpress(ALTMETA.."F2", "mod_query.exec_on_merr(_, XTERM or 'urxvt -tr -tint black -sh 30 -rv -sr')"),
...
defmenu("mainmenu", {
    ...
    menuentry("Terminal",       "mod_query.exec_on_merr(_, XTERM or 'urxvt -tr -tint black -sh 30 -rv -sr')"),
